        ...
        allExams.forEach(exam => {
            ...
            if (!examsByTitle[exam.examTitle] ||
                ...
                examsByTitle[exam.examTitle] = {
                    ...
                    isAvailable,
                    availableFrom,
                    availableFromFormatted: availableFrom.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }),
                    startDateFormatted: startDate.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }),
                    endDateFormatted: endDate.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })
                };
            }
        });
